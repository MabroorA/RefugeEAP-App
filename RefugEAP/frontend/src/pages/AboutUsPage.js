...
const AboutUs = () => {
  return (
    <div>
      ...
      <ul>
        <div id='paragraph'>
        <li>To put social justice on the agenda in EAP discussions concerning learning, teaching, scholarship of teaching and learning, research and operational matters, in part through widening the parameters of the field.</li>
        <li>To demonstrate the value of adopting a social justice lens in EAP, by broadening and strengthening the evidence base of the impact that this can make in our field.</li>
